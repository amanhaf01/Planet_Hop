...
-- virtual resolution handling library for retro look 
push = require 'push'
...
-- starting scroll location in x-axis
...
function love.load()
    ...
    -- app window title
    love.window.setTitle('Planet Hop')
...
-- function used to check our global input table for keys we activated during this frame, looked up by their string value
